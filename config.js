...
<div class="app">
  <header class="topbar">
    ...
    <div class="header-actions">
      ...
      <span class="badge mono" title="Frontend version" style="font-size:11px">v<span id="app-version">live</span></span>
...
const APP_VERSION = window.MTGMP_APP_VERSION || "2026.04.28.frontend-full-replacement";
const API_URL = (window.MTGMP_API_URL || "http://localhost:3000").replace(/\/$/, "");
...
async function loadData(){
  ...
  try{
    ...
    console.warn("Live API load failed. Using demo data.", e.message);
...
(function boot(){
  ...
  if($("app-version")) $("app-version").textContent = String(APP_VERSION).split(".").slice(-1)[0] || "live";
  initEvents();
  loadData();
